...
def main(test=False) -> [[]]:
    ...
    boards_menu.add_option('Play', playLoadedMatrix)
    boards_menu.add_option('default   Example   1', setLoadedMatrix, defaultGrid1)
    boards_menu.add_option('default   Example   2', setLoadedMatrix, defaultGrid1)
    boards_menu.add_option('Random   Board', setLoadedMatrix, randomGrid)
    boards_menu.add_option('Load   from   file', setLoadedMatrix, None)
