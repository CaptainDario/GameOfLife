...
\begin{section}{Implementierung}
	...
	\subsection{Menüleiste (während des Spiels)}
        ...
        Die Menüleiste im, unteren Bereich des Fensters, ermöglicht es das Spiel zu starten und zu pausieren (\ding{228}/ \ding{110}),
        die Geschwindigkeit zu erhöhen (+), oder zu verlangsamen (-), sowie einzelne schritte zu machen (\ding{225}).
